...
gulp.task('sass', function () {
    ...
    return gulp.src(['./src/**/*.scss'])
        ...
        .pipe(gulp.dest(cssDest)).on('end', function () {
            gulp.src(['./docs/index.html', './docs/index2.html', './docs/404.html', './docs/about.html', './docs/gallery.html'])
                .pipe(injectCSS())
                .pipe(gulp.dest('./docs/')).on('end', function () {
...
gulp.task('templates', function () {
    gulp.src(["./src/templates/*.html", "./src/templates/popovers/*.html"])
        ...
        .pipe(gulp.dest('docs/templates')).on('end', function () {
            var files = ['./docs/templates/index.html', './docs/templates/index2.html', './docs/templates/404.html', './docs/templates/about.html', './docs/templates/gallery.html'];
            gulp.src(files)
